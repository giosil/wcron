...
@WebServlet(name = "WebClasses", loadOnStartup = 0, urlPatterns = { "/classes/*" })
public 
class WebClasses extends HttpServlet 
{
  private static final long serialVersionUID = 5828279809715229381L;
  ...
  File getFile(HttpServletRequest request)
  {
    ...
    return WCronConfig.getClassFile(pathInfo);
  }
}
